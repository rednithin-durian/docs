...
<url get=""><div class="ib">/payments/va/:id</div></url>
...
conn.request("GET", "/v1/payments/va/va_sample_6YBBiGRAPa0943", payload, headers)
...
Request request = new Request.Builder()
  .url("https://api.durianpay.id/v1/payments/va/va_sample_6YBBiGRAPa0943")
  .method("GET", body)
...
url = URI("https://api.durianpay.id/v1/payments/va/va_sample_6YBBiGRAPa0943")
